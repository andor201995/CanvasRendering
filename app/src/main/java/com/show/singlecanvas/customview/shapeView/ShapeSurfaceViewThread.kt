...
class ShapeSurfaceViewThread(context: Context, private val iTalkToSlideView: ITalkToSlideView) : SurfaceView(context),
    ...
    private fun drawOnCanvas(dirtyRect: Rect = Rect(0, 0, right, bottom)) {
